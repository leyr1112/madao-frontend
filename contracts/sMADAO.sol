...
contract sMaDaoToken is ERC20Permit, Ownable {
    ...
    uint256 private constant INITIAL_FRAGMENTS_SUPPLY = 100000000 * 10**18;
    ...
    constructor() ERC20("Staked Mystic Aliens Dao", "sMADAO", 9) ERC20Permit() {
    ...
    /**
        @notice increases sMADAO supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sMADAO
