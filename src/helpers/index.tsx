...
import { ReactComponent as MadaoImg } from "../assets/tokens/MADAO.svg";
import { ReactComponent as SMadaoImg } from "../assets/tokens/SMADAO.svg";

import { madao_busd } from "./AllBonds";
...
export async function getMarketPrice({ networkID, provider }: IBaseAsyncThunk) {
  const madao_busd_address = madao_busd.getAddressForReserve(networkID);
  const pairContract = new ethers.Contract(madao_busd_address, PairContract, provider);
...
export async function getTokenPrice(tokenId = "madao") {
