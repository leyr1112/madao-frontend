...
function NavContent() {
  ...
  const checkPage = useCallback((match, location, page) => {
    ...
    if (currentPath.indexOf("nft-mint") >= 0 && page === "nft-mint") {
      return true;
    }
    if (currentPath.indexOf("nft-staking") >= 0 && page === "nft-staking") {
      return true;
    }
      ...
      <Box className="dapp-sidebar-inner" display="flex" justifyContent="space-between" flexDirection="column">
        <div className="dapp-menu-top">
          <Box className="branding-header">
            <Link href="https://app.mysticaliens.com/" target="_blank">
              <SvgIcon
                color="primary"
                component={MadaoIcon}
                viewBox="0 0 161 161"
                style={{ minWdth: "151px", minHeight: "161px", width: "120px" }}
              />
              <div className="wallet-link f-32">Mystic Aliens Dao</div>
            </Link>
            {address && (
          ...
          <div className="dapp-menu-links">
            <div className="dapp-nav" id="navbarNav">
              ...
              <Link
                ...
                to="/nft-mint"
                isActive={(match, location) => {
                  return checkPage(match, location, "nft-mint");
                }}
                className={`button-dapp-menu ${isActive ? "active" : ""}`}
              >
                <Typography variant="h6">
              ...
              <Link
                ...
                to="/nft-staking"
                isActive={(match, location) => {
                  return checkPage(match, location, "nft-staking");
                }}
                className={`button-dapp-menu ${isActive ? "active" : ""}`}
              >
                <Typography variant="h6">
